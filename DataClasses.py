...
class Person:
    ...
    changelog: (When,Who,What)
        ...
        NHertlein, 2021.03.15, Coiped Person class from Listing06.py and pasted it here
    """
...
class Employee(Person):  # Inherits from Person
        ...
        changelog: (When,Who,What)
            RRoot,1.1.2030,Created Class
            NHertlein,2021.03.15, Coiped Employee class from Listing09.py and pasted it here
        """

        def __init__(self, employee_id, first_name, last_name):
            # Attributes
            self.__employee_id = employee_id  # New Attribute
            self.first_name = first_name  # From Person class
            self.last_name = last_name  # From Person class
