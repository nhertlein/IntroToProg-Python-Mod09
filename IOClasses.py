# ---------------------------------------------------------- #
# Title: IO Classes
# Description: A module of Input/Output functions
...
class EmployeeIO:
    ...
    changelog: (When,Who,What)
        ...
        NHertlein,2021.03.16, Copied EmployeeIO from listing12.py and pasted it here
    """
    @staticmethod
    ...
    def print_current_list_items(list_of_rows: list):
        ...
        for row in list_of_rows:
            print(row.to_string())  # This worked much easier, other text was giving errors
        print("*******************************************")
        print()  # Add an extra line for looks
